...
DB_PATH = os.path.join(BASE_DIR, "cocowork.db")
PUBLIC_DIR = os.path.join(BASE_DIR, "public")

DEFAULT_ADMIN_EMAIL = "admin@cocowork.local"
...
class CocoworkHandler(BaseHTTPRequestHandler):
    def do_OPTIONS(self):
...
if __name__ == "__main__":
    ...
    host = "0.0.0.0"
    port = 8000
    print(f"Cocowork server running at http://{host}:{port}")
    HTTPServer((host, port), CocoworkHandler).serve_forever()
